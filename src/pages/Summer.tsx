    ...
    return (
        <div className="pt-32 pb-20 bg-white min-h-screen">
            <div className="container mx-auto px-6 mb-20 text-center">
                ...
                <h1 className="text-4xl md:text-6xl text-[#1a1a1a] font-heading mb-8 animate-in fade-in zoom-in-95 duration-1000 delay-100">Summer Adventures</h1>
            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {/* Card 1 */}
                <div className="bg-white border border-gray-100 group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl rounded-sm overflow-hidden">
                    ...
                    <div className="p-8">
                        ...
                        <h3 className="text-xl text-[#1a1a1a] font-heading mb-4">Mountain Biking</h3>
                ...
                <div className="bg-white border border-gray-100 group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl rounded-sm overflow-hidden">
                    ...
                    <div className="p-8">
                        ...
                        <h3 className="text-xl text-[#1a1a1a] font-heading mb-4">Golfing</h3>
                        <p className="text-gray-500 mb-6 text-sm leading-relaxed">
                ...
                <div className="bg-white border border-gray-100 group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl rounded-sm overflow-hidden">
                    ...
                    <div className="p-8">
                        ...
                        <h3 className="text-xl text-[#1a1a1a] font-heading mb-4">Fly Fishing</h3>
                        <p className="text-gray-500 mb-6 text-sm leading-relaxed">
                ...
                <div className="bg-white border border-gray-100 group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl rounded-sm overflow-hidden">
                    ...
                    <div className="p-8">
                        ...
                        <h3 className="text-xl text-[#1a1a1a] font-heading mb-4">Rafting</h3>
                        <p className="text-gray-500 mb-6 text-sm leading-relaxed">
            ...
            <div className="container mx-auto px-6 mt-20 text-center">
                <a
                    ...
                    className="inline-block bg-[#c6a87c] hover:bg-[#d4b88f] text-white px-12 py-5 font-bold uppercase tracking-widest transition-all hover:scale-105 shadow-md hover:shadow-xl"
                >
